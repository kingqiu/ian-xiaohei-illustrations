...
画法：左侧输入，中间小小克或怪机器处理，右侧输出。主流向优先用酒红信号/刻度表达，必要时少量橙色箭头。

### 系统局部

适合：信息来源、过滤器、数据库、渲染器、agent 系统局部。

画法：只画 3-5 个核心模块，小小克参与其中一个关键动作。
...
画法：一层层盒子，不要正式金字塔；小小克在旁边搬砖、压住、称量或搭建。

### 地图路线

适合：从想法到上线、用户路径、内容承接路径、学习路线。

画法：一条弯曲路径，少量节点，小小克牵线、压住线索或作为配重。
...
3. 让小小克承担动作：不是站旁边，而是卡在机器里、拉错线、守门、搬运、修补、称重、校准、压住噪音、沉淀信息、扶梯子、记录、把东西塞进某个怪装置。

### 可用物件池

- 纸箱、抽屉、旧机器、漏斗、秤、刻度尺、校准旋钮、邮筒、门、井、梯子、水管、线团、闸门、转盘、黑盒、打孔器、压面机、晾衣绳、怪工位。
- 用时只选 1-2 个，不要堆满。

### 小小克动作池

- 拉、扛、塞、捞、压、称、校准、沉淀、探测、压扁、牵住、缝、剪、拧、守、推、接、拆、标记、回收。
- 动作要服务核心意思，不要为了怪而怪。
...
同类主题也要换新隐喻。例如“承接路径”不一定画路线，可以画小小克把内容尾巴压到门把手上；“一鱼多吃”不一定画鱼，可以画小小克把一个纸团压成几种形状。
